              ...
              <div className="lg:flex">
                <div className="w-full mb-12 lg:mb-0 lg:w-1/2">
                  ...
                  <p className="text-gray-400">
                    Thinkx Cloud is the leading hosting and cloud service
                    provider in uganda, Customer satsfaction is our goal.
                  </p>
                  <p className="text-gray-400">
                    ...
                    <span className="flex items-center ">
                      Call: +256(0)393255008 / +256(0)200904980
                    </span>
                  </p>
                  <div className="flex mt-6">
                    <a
                      style={{ backgroundColor: " #3B5998" }}
                      href="https://www.facebook.com/thinkxsoftware/"
                      target="_blank"
                    ...
                    <a
                      ...
                      className="flex items-center justify-center h-12 w-12 mx-1 rounded-full fab cursor-pointer 
                                            fill-current text-white text-xl fa-twitter"
                    ></a>
                    <a
                      style={{ backgroundColor: "#4CCA5A" }}
                      href="https://wa.me/256760137160"
                      target="_blank"
                      className="flex items-center justify-center h-12 w-12 mx-1 rounded-full fab cursor-pointer 
                ...
                <div className="w-full lg:w-1/2 lg:flex lg:px-6 ">
                  <div className="w-full mb-6 lg:mb-0 lg:w-1/2">
                    ...
                    <ul className="text-gray-500 text-sm ">
                      ...
                      <li className="pt-1 pb-2 list-none hover:text-white">
                        <a
                          href="https://www.thinkxsoftware.com/about/"
                          target="_blank"
                          className="cursor-pointer"
                        >
                          About Us
